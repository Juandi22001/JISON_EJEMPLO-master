%{
   ...
   const {Operaciones}=require('../ClasesParaArbol/Operaciones')
    const {'id'_Solo}=require('../ClasesParaArbol/'id'_Solo')
...
stringliteral (\"[^"]*\")
'id'entifier ([a-zA-Z_])[a-zA-Z0-9_]*
caracter (\'[^☼]\')
...
{comentarioBloque}    {console.log("comentario Bloque reconoc'id'o");return 'comentarioBloque'}
{comentarioLinea}     {console.log("comLinea reconoc'id'o"); return 'comentarioLinea'}
":"                   return ':'
"/"                   return '/'
";"                   return ';'
"--"                  return 'decremento'
...
DeclaracionClase: 'public' 'vo'id'' 'id' '(' Metodos_Funciones {$$ new Metodo_C(this._$.first_line,this._$.first_column,$1,$2,$3,$4);}
                        | 'vo'id'' 'id' '(' Metodos_Funciones  {$$ new Metodo_C(this._$.first_line,this._$.first_column,".",$2,$3,$4);}
                       | 'public' TIPO 'id' '(' Metodos_Funciones   {$$ new Funcion_C(this._$.first_line,this._$.first_column,$1,$2,$3,$4);}
                        ...
                        | 'public' TIPO L_'id's AsignacionV_P {$$ new DeclaracionAfuera(this._$.first_line,this._$.first_column,$1,$2,$3,$4);}
                        | 'public'  'static' 'vo'id'' 'main' '(' 'S tring' '[' ']'  'args' ')' BlockInstrucciones {$$ new Main(this._$.first_line,this._$.first_column,$4,$10);}
                        | TIPO L_'id's AsignacionV_P {$$ new DeclaracionAfuera(this._$.first_line,this._$.first_column,".",$2,$3,$4);}
...
EXPRESION_METODO: 'id' '(' Llamar_Metodo_Exp ')' {$$ new LlamadaMetodo(this._$.first_line,this._$.first_column,$1,$3);} 
                | 'id' '(' ')'    {$$ new LlamadaMetodo(this._$.first_line,this._$.first_column,$1,[]);} 
                | 'id'   {$$ new 'id'_Solo(this._$.first_line,this._$.first_column,$1);} 
                ;
...
DeclaracionM_Funciones: TIPO L_'id's AsignacionV_P {$$ new DeclaracionMF(this._$.first_line,this._$.first_column,$1,$2,$3);} 
                                        ;


L_'id's: L_'id's ',' 'id'  { $1.push($3); $$ = $1; }
         | 'id'  { $$ = [$1]; }
         ; 
